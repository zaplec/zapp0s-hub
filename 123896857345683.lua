...
local Config = {
    WindowName = "zapp0s hub | " .. game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name,
    Color = ourColor,
...
infoSec:CreateButton("Father of zapp0s hub: zap#9999", function()
    setclipboard("zap#9999")
    
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "zapp0s hub Note",
        Text = "Copied zap's discord username and tag to your clipboard.",
        Duration = 5
    })
end)
...
infoSec:CreateButton("Help with a lot: Luv u2mj ღ#8910", function()
    ...
    game:GetService("StarterGui"):SetCore("SendNotification", {
        ...
        Text = "Copied u2mj's discord username and tag to your clipboard.",
        Duration = 5
    })
end)
...
infoSec:CreateButton("Join us on discord!", function()
	if req then
        ...
        setclipboard("https://discord.gg/dnWS36eAC3")
...
game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "Please Note",
    Text = "The zapp0s hub version you are using is currently in alpha, bugs may occur.",
    Duration = 10
})