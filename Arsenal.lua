...
local zapp0s = "buifzuifiqzuifizfui"

VisualsTabESPSection:Toggle("Banana ESP (Monkey Business Mode)",function(zapp0ss)
for i,v in pairs(game.Workspace:GetDescendants()) do -- grabs everything from workspace
    ...
    if zapp0ss then 
        ...
        v.Parent:FindFirstChild(zapp0s):Destroy()
    end
end
end
end)
